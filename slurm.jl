...
function seed()
  ...
  @everywhere P = HiaParameters(simtime = 30*365)
  @everywhere M = ModelParameters(numofsims = 100, initializenew = true, vaccineon=false, savejld=true)  ## start with vaccine off
