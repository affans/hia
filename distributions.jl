...
"""
Returns the probability matrix and the cumulative probability matrix for contact behaviour in the model. The rate matrix (below) used is from the Jackson paper:
'''
